...
public class RenderResizableCuboid {
    ...
    public static void renderCube(RenderUtils.Model3D cube, PoseStack matrix, VertexConsumer buffer, int argb, int light, int overlay, FaceDisplay faceDisplay, Camera camera,
     ...
     */
    public static void renderCube(RenderUtils.Model3D cube, PoseStack matrix, VertexConsumer buffer, int[] colors, int light, int overlay, FaceDisplay faceDisplay, Camera camera,
                                  @Nullable Vec3 renderPos) {
