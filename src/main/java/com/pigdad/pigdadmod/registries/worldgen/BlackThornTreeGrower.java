...
public class BlackThornTreeGrower extends AbstractTreeGrower {
    @Nullable
    @Override
    ...
    public static ResourceKey<ConfiguredFeature<?, ?>> registerConfigKey(String name) {
        return ResourceKey.create(Registries.CONFIGURED_FEATURE, new ResourceLocation(PigDadMod.MODID, name));
    }
}
